# Governance and Operational Framework for the DPI-H Reference Architecture Technical Working Group (TWG) - Reference Architecture v0.2.0

* [**Table of Contents**](toc.md)
* [**Home**](index.md)
* **Governance and Operational Framework for the DPI-H Reference Architecture Technical Working Group (TWG)**
...
1. **Trust Services Domain**
1. **Metadata Registries Domain** 
1. **Clinical Services Domain**(incl. Patient records and Clinical Workflows) 
1. **Health Supply Chain Domain**
1. **Financial Systems in Health Domain **
...
* Interoperability coordination: Interface design sessions between dependent domains **Standards Harmonization:**
* Consistent application of architectural principles
* Shared terminology and data definitions
* Common security and privacy frameworks **Dependency Management**
* Dependency mapping between components
* Regular dependency review and validation **Conflict Resolution:**
...
1. Create Issue on GitHub and/or submit pull request via GitHub
1. Domain co-chair initial assessment
1. Domain Group review
1. Cross-domain impact evaluation (if applicable)
1. Chief Architect approval for significant changes
1. Implementation and communication of approved changes
